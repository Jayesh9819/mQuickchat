...
<body>
  ...
  <div class="sidenav-wrapper" id="sidenavWrapper">
    ...
    <ul class="sidenav-nav">
      <li>
        <a href="live.html">
          <i class="lni lni-play"></i> Live
          <span class="red-circle ml-2 flashing-effect"></span>
        </a>
      </li>
      <li>
        <a href="profile.html">
      ...
      <li>
        <a href="pages.html">
          <i class="lni lni-files"></i> All Pages
          <span class="ml-2 badge badge-danger">HOT</span>
        </a>
      </li>
      <li>
        <a href="catagory.html">
          <i class="lni lni-grid-alt"></i> All Category
          <span class="ml-2 badge badge-warning">14+</span>
        </a>
      </li>
      <li>
      ...
      <li>
        <a href="login.html">
          <i class="lni lni-power-switch"></i> Log In
        </a>
      </li>
    </ul>
  ...
  <script src="js/date-clock.js"></script>
